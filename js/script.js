...
const alertErrorComprar = ()=> {
  Swal.fire({
    ...
    footer: '<strong>Por Favor Seleccione un Producto para Continuar!</strong>'
  })
}
const comprarButton = document.querySelector(".comprarButton")
comprarButton.addEventListener("click",comprarButtonClicked)
function comprarButtonClicked() {
 if(carritoDiv.textContent==""){
  alertErrorComprar()
 }else{
  cartComprado()
  const buttonComprar = document.querySelector(".shoppingCartItem")
